...
#plot
women
plot(women)# minimum of one data is needed in the order x aand y
plot(women, type='p', pch=16, col='purple')
plot(women, type='l')
plot(women, type='b', pch=16, col='purple')
...
plot(x=mtcars$wt,y=mtcars$mpg, col=mtcars$gear, cex=mtcars$cyl, pch=mtcars$am)
...
hist(women$height, breaks=5, col=1:6)
