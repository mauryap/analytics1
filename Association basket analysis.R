# basket analysis
#3 measure usd in market analysis --confidence lift and support check rule on google. R will cALCULATE ALL THE POSSIBLE COMBINATION AND WILL TELL YOU THE PATTERN which is followed.
